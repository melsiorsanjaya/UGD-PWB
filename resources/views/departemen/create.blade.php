...
<div class="card">
<div class="card-body">
<form action="{{ route('departemen.store') }}"
...
<input type="text" class="form-control @error('nama_manager') is-invalid @enderror" name="nama_manager"
value="{{ old('nama_manager') }}" placeholder="Masukkan Nama Manager">
@error('nama_manager')
<div class="invalid-feedback">
{{ $message }}
</div>
...
<input type="number" class="form-control @error('jumlah_pegawai') is-invalid @enderror"
